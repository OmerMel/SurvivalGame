...
public class Activity_Game extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        Activity_Game.super.onCreate(savedInstanceState);
    ...
    /* JADX WARNING: type inference failed for: r4v0, types: [com.classy.survivegame.Activity_Game, android.content.Context] */
